...
* Switched to official Maven Central publication (`link.routix.sdk:routix`).
...
* Initial release of the Routix Android SDK.
* High-precision attribution via Google Play Install Referrer.
* Direct and Deferred deep link resolution.
